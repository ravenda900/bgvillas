...
<section class=" clearfix bg-lgrey">
    ...
    <div class="col-md-6 bg-silver bor-l">
        <div class="sec-padding --small clearfix">
            <h1 class="inside-h1 ta-center fc-primary ff-secondary fw-normal">Let's Meet</h1>
            <h6 class="ta-center ff-secondary fw-normal">Help us get to know you better</h6>
            <p class="ta-center mbpx-30">
                <br />
                Please complete the form below to make an inquiry and speak with our experienced team.
            </p>
...
<section class="clearfix bg-silver">
   ...
   <div class="col-md-8">
        <div class="sec-padding clearfix">
            <a href="../careers" class="inside-h1 ta-center sec-padding --small fc-primary ff-secondary d-block fw-normal">Looking for a job?</a>
        </div>
    </div>
