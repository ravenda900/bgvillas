...
<!-- Page Banner Section -->
<section class="hero-banner blogs-banner d-table w-100 bg-center bg-cover" style="background-image:url(<?php the_post_thumbnail_url(); ?>)">
...
<section class="sec-padding --small inside-page clearfix">
    <div class="container">
	    <div class="col-md-12">
	        ...
	        <div class="res-width">
	        	<div class="tt-uppercase mbpx-20 fc-secondary"> <i class="fa fa-clock-o prpx-6"></i> <?php echo get_the_date(); ?></div>
...
<div class="sec-padding --small bg-dgrey">
	<div class="container">
		<div class="row">
			
			<h3 class="fc-white ta-center tt-uppercase mbpx-20"> Related Posts </h3>
			  		

    		<div class="blogs-slider dots-n-arrow --white-dots clearfix">

	    		<?php
			        $args = array( 'post_type' => 'blogs', 'posts_per_page' => -1, 'order'=> 'ASC', 'orderby' => 'post_date', 'post__not_in' => array($post->ID), );
			        ...
			        <div class='col-md-4'>
			            <div class="box blogs-box matchheight">
			                ...
			                <div class="inner-content clearfix">
			                    ...
			                    <a href="<?php the_permalink();?>" class="btn --small btn-primary">READ MORE</a>                
			                </div>
			            </div>
			        </div>               
			    <?php
